...
pub enum SkillStorageLocation {
    /// Tako Switch 管理目录 (~/.tako-switch/skills/)
    #[default]
    CcSwitch,
...
impl SkillService {
    ...
    /// 获取 SSOT 目录（根据设置返回 ~/.tako-switch/skills/ 或 ~/.agents/skills/）
    ...
    /// 获取 Skill 卸载备份目录（~/.tako-switch/skill-backups/）
    ...
    /// 扫描未管理的 Skills
    ///
    /// 扫描各应用目录，找出未被 Tako Switch 管理的 Skills
    ...
    /// 从应用目录导入 Skills
    ///
    /// 将未管理的 Skills 导入到 Tako Switch 统一管理
